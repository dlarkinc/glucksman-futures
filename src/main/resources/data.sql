...
VALUES (1,'Do you find art more enjoyable when it appeals to your senses?','Victor Burgin, Possession','Corey McCorkle, Dandelion Wine','Ai Weiwei, One Ton of Tea (delicious vapours of tea emanate from the art piece)');

INSERT INTO questions (page,question,desc1,desc2,desc3)
VALUES (2,'Why do we find the ugly so fascinating in art?','Quentin Metsys, The ugly duchess or grotesque old woman (1513)','Louise Bourgeois, Maman','ORLAN (1997)');
...
INSERT INTO questions (page,question,desc1,desc2,desc3)
VALUES (5,'Can an ephemeral artistic experience be considered a work-of-art?','Studio Roosegaarde: WATERLICHT is the dream landscape about the power and poetry of water. As a virtual flood, it shows how high the water could reach without human intervention.','Antonia Hirsch, Garden of Earthly Delights','PIRATBYRÅN (The Bureau of Piracy), Please join the Party, 2008: Party in a Bus');
...
INSERT INTO questions (page,question,desc1,desc2,desc3)
VALUES (8,'Is art a powerful tool for subverting social and political structures?','Colin Darke, Capital Paintings','Fred Wilson, Metalwork 1793 - 1880 (silverware with slave handcuffs)','Lida Abdul, Brick Sellers of Kabul');

INSERT INTO questions (page,question,desc1,desc2,desc3)
VALUES (9,'What is art if it is not unique, material nor durable?','The Welfare State, M HKA, Antwerp featuring posters','Meschac Gaba, Du mur a la toile-Couleurs de Cotonou','20-inch Copper (FedEx Boxes) bruised during transport around the world');

INSERT INTO questions (page,question,desc1,desc2,desc3)
VALUES (10,'What is art outside the traditional capitalist conception?','Rafaël Rozendaal (2011): Art Website Sales Contract','Copyleft: offering people the right to freely distribute copies of a work','Future Gallery: a Dual Site exhibiting digital art mainly online');
